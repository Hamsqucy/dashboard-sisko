...
<head>
  ...
  <title>Ubhara Jaya | Edit Mata Pelajaran</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="home3.html" class="brand-link">
  ...
  <?php 
        ...
        $sql = "SELECT * FROM mmatpel WHERE id_matpel='$_GET[id_matpel]'";
    ...
    <!-- SELECT2 EXAMPLE -->
        <div class="card card-default">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
                ...
                <form action="edit_proses_pelajaran.php" method="post">
				    
                    <div class="form-group">
                        <label>ID Matpel</label>
				                <input type="text" class="form-control" value="<?php echo $data['id_matpel']; ?>" name="id_matpel" >
					          </div>

                    <div class="form-group">
						            <label>Nama Matpel</label>
						            <input type="text" class="form-control" value="<?php echo $data['nama_matpel']; ?>" name="nama_matpel">
				          	</div>
               
                    <div class="form-group">
						            <label>Status</label>
						            <input type="text" class="form-control"  value="<?php echo $data['status_pelajaran']; ?>" name="status_pelajaran" >
					          </div>
                    
                    <div class="modal-footer">
					              <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
                        <input type="hidden" name="id_matpel" value="<?php echo $data['id_matpel'];?>">
          ...
          <div class="card-footer">
           <i>Masukkan Edit <b>Data Mata Pelajaran</b> Secara Benar ! </i>
