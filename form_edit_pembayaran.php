...
<head>
  ...
  <title>Ubhara Jaya | Edit Pembayaran</title>
...
<div class="wrapper">
  ...
  <?php 
        ...
        $sql = "SELECT * FROM tpembayaran WHERE id_pembayaran='$_GET[id_pembayaran]'";
    ...
    <!-- SELECT2 EXAMPLE -->
        <div class="card card-default">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
                ...
                <form action="edit_proses_pembayaran.php" method="post">
				    
                <div class="form-group">
							    <label>ID Pembayaran</label>
							    <input type="text" class="form-control" placeholder="Kosongkan" value="<?php echo $data['id_pembayaran']; ?>" name="id_pembayaran" >
                </div>

						    <div class="form-group">
                  <label>NIS</label>
                  <select name="nis" class="form-control" autocomplete="off" value="<?php echo $data['nis']; ?>">
                ...
                <div class="form-group">
                  ...
                  <select name="id_kelas" class="form-control" autocomplete="off" value="<?php echo $data['id_kelas']; ?>">
                ...
                <div class="form-group">
							    ...
							    <select name="id_tahun_ajaran" class="form-control" autocomplete="off" value="<?php echo $data['id_tahun_ajaran']; ?>">
                ...
                <div class="form-group">
							    ...
							    <select name="id_semester" class="form-control" autocomplete="off"  value="<?php echo $data['id_semester']; ?>">
                ...
                <div class="form-group">
							    ...
							    <select name="id_jenis_pembayaran" class="form-control" autocomplete="off" value="<?php echo $data['id_jenis_pembayaran']; ?>">
                ...
                <div class="form-group">
                  ...
                  <select name="no_virtual_account" class="form-control" autocomplete="off" value="<?php echo $data['no_virtual_account']; ?>">
                ...
                <div class="form-group">
							          ...
							          <input type="number" class="form-control" autocomplete="off" value="<?php echo $data['nilai_pebayaran']; ?>" name="nilai_pebayaran">
					    	</div>
                ...
                <div class="form-group">
                  ...
                  <select name="id_kasir" class="form-control" autocomplete="off" value="<?php echo $data['id_kasir']; ?>">
          ...
          <div class="card-footer">
           <i>Masukkan Edit <b>Data Pembayaran</b> Secara Benar ! </i>
