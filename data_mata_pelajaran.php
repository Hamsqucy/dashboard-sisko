...
<head>
  ...
  <title>Ubhara Jaya | Mata Pelajaran</title>
            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">
                  ...
                  <a href="#addDataPelajaran" class="btn btn-success" data-toggle="modal"> <span>Tambah Data</span></a>
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap">
                  ...
                  <?php 
                      ...
                      $sql = mysqli_query($koneksi, "SELECT * FROM mmatpel");
                      $no = 1;
                  ...
                  <tbody>
                    <tr>
                        <td><?php echo $no++;?></td>  
                        <td><?php echo $data['id_matpel'];?></td>  
                    		<td><?php echo $data['nama_matpel'];?></td>
                    		<td><?php echo $data['status_pelajaran'];?></td>
							          <td><?php echo $data['created_at'];?></td>
							          <td><?php echo $data['updated_at'];?></td>

                    <td>
                      <a href="form_edit_pelajaran.php?id_matpel=<?php echo $data['id_matpel']?> ">
                      <button type="button" class="btn btn-warning" name=""> <i class="fa fa-pencil"></i> Edit</button></a>
                      <a onclick="return confirm('Ingin Menghapus Data ?')" href="delete_mata_pelajaran.php?id_matpel=<?php echo $data['id_matpel']?>">
...
<!-- Tambah Data -->     
	<div id="addDataPelajaran" class="modal fade">
		<div class="modal-dialog">
			<div class="modal-content">
      
      <form action="data_mata_pelajaran.php" method="post">
					...
					<div class="modal-body">					
						<div class="form-group">
							...
							<input type="text" class="form-control" name="id_matpel" id="id_matpel">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label>Status</label>
							<input type="text" class="form-control" name="status_pelajaran" id="status_pelajaran">
						</div>
					</div>
  ...
  <?php
    include "koneksi.php";
      ...
      if(isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO mmatpel (id_matpel, nama_matpel, status_pelajaran)
        VALUES ('$id_matpel', '$nama_matpel', '$status_pelajaran')";
