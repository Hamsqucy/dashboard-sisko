...
<head>
  ...
  <title>Ubhara Jaya | Edit Siswa</title>
...
<div class="wrapper">
  ...
  <?php 
        ...
        $sql = "SELECT * FROM msiswa WHERE nis='$_GET[nis]'";
    ...
    <!-- SELECT2 EXAMPLE -->
        <div class="card card-default">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
                ...
                <form action="edit_proses_siswa.php" method="post">
                    ...
                    <div class="form-group">
						            <label>Foto</label>
						            <input type="file" class="form-control"  value="<?php echo $data['foto']; ?>" name="foto" >
					          </div>
                    ...
                    <div class="form-group">
						            ...
						            <input type="text" class="form-control"  value="<?php echo $data['asal_sekolah']; ?>" name="asal_sekolah" >
					          </div>

                    <div class="form-group">
						            <label>Nama Ortu</label>
						            <input type="text" class="form-control"  value="<?php echo $data['nama_ortu']; ?>" name="nama_ortu" >
					          </div>

                    <div class="form-group">
						            <label>Pekerjaan Ortu</label>
						            <input type="text" class="form-control"  value="<?php echo $data['pekerjaan_ortu']; ?>" name="pekerjaan_ortu" >
					          </div>
          ...
          <div class="card-footer">
           <i>Masukkan Edit <b>Data Siswa</b> Secara Benar ! </i>
